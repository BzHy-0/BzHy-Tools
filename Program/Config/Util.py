...
try:
    ...
    print(f'Modules of the python library required for bzhy are not installed, make sure you have correctly installed python and have launched the "Setup.py" file which will install all the necessary modules.')
    input(f'Error: {e}')

color_webhook = 0xa80505
username_webhook = name_tool
avatar_webhook = 'https://cdn.discordapp.com/attachments/1268900329605300234/1276010081665683497/bzhy-Logo.png?ex=66cf38be&is=66cde73e&hm=696c53b4791044ca0495d87f92e6d603e8383315d2ebdd385aaccfc6dbf6aa77&'
...
def Reset():
    if os_name == "Windows":
        file = ['python', os.path.join(tool_path, "bzhy.py")]
        subprocess.run(file)

    elif os_name == "Linux":
        file = ['python3', os.path.join(tool_path, "bzhy.py")]
        subprocess.run(file)
